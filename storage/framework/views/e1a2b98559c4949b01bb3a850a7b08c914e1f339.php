...
>
    ...
    <div class="px-6 py-4 ">
        <div class="font-bold text-xl mb-2 text-gray-600 dark:text-white line-clamp-2">
            <a class="post-link" href="<?php echo e(route('post.show', $post->slug)); ?>"><?php echo e(ucfirst($post->title)); ?></a>
        </div>
       <div class="absolute bottom-2 max-w-[90%]">
        ...
        <span class="flex justify-between  text-sm font-semibold text-gray-700  mb-2">
            <?php $__currentLoopData = $post->wasteTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wasteType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('waste_type.show', $wasteType->slug)); ?>" class=" flex flex-row items-center md:hover:underline underline-offset-2 group bg-gray-200 rounded-full px-3 my-3">
...
<path d="M41.9231 144H33.6154C29.2087 144 24.9825 141.925 21.8665 138.232C18.7505 134.539 17 129.53 17 124.308V35.6923C17 30.4696 18.7505 25.4608 21.8665 21.7677C24.9825 18.0747 29.2087 16 33.6154 16H108.385C112.791 16 117.017 18.0747 120.133 21.7677C123.249 25.4608 125 30.4696 125 35.6923V45.5385"  stroke-width="8.16667" stroke-linecap="round" stroke-linejoin="round"/>
           ...
           <div class="flex justify-between">
               ...
               <p class="w-3/5 text-base text-gray-700 dark:text-white truncate">
                   <?php echo e(ucfirst($post->location)); ?>
           ...
           <div class=" text-gray-700 dark:text-white flex justify-between">
               <p class="flex items-center" >
                   <span class="text-2xl font-bold mr-1"><?php echo is_null($post->price)? 'Free' :ucfirst($post->price).'<span class="text-base font-normal">zł</span>'; ?> </span>
               </p>
               <?php if($hasSaved): ?>
...
<?php /**PATH /Users/kylymbekmazaripov/Sites/ecomoney/resources/views/livewire/post-index.blade.php ENDPATH**/ ?>