...
<?php endif; ?>
    ...
    <div class="mt-5 md:mt-0 md:col-span-2 ">
        <form wire:submit.prevent="<?php echo e($submit); ?>">
            <div class="px-4 py-5 bg-white dark:bg-gray-700 sm:p-6 shadow <?php echo e(isset($actions) ? 'sm:rounded-tl-md sm:rounded-tr-md' : 'sm:rounded-md'); ?>">
            ...
            <?php if(isset($actions)): ?>
                <div class="flex items-center justify-end px-4 py-3 bg-gray-50 dark:bg-gray-500 text-right sm:px-6 shadow sm:rounded-bl-md sm:rounded-br-md">
                    <?php echo e($actions); ?>
...
<?php /**PATH /Users/kylymbekmazaripov/Documents/projects/and/resources/views/vendor/jetstream/components/form-section.blade.php ENDPATH**/ ?>