...
} elseif ($_instance->childHasBeenRendered('l4125433583-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l4125433583-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l4125433583-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l4125433583-0');
} else {
    $response = \Livewire\Livewire::mount('comment-notifications', []);
    $html = $response->html();
    $_instance->logRenderedChild('l4125433583-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                         <?php echo $__env->renderComponent(); ?>
