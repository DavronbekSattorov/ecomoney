        ...
        <div class="w-full flex flex-col justify-between mx-4 ">
            <div class="flex flex-row items-center justify-between  dark:bg-gray-800 bg-gray-100  z-10">
                <div class="flex flex-row items-center ">
                    <a href="<?php echo e(route('user.show', $post->user->username)); ?>" class="flex flex-row items-center md:hover:underline underline-offset-2 group text-base">
...
<?php endif; ?>
            ...
            <div class="cursor-pointer ">
                <a href="https://www.google.pl/maps/place/<?php echo e($post->location); ?>">
                    <img src="<?php echo e(asset('/images/map.jpg')); ?>" class="h-32 w-full object-cover" alt="">
                </a>
            </div>
            <?php $__currentLoopData = $post->wasteTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wasteType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="flex justify-start items-center text-sm mt-6">
                    ...
                    <?php $__currentLoopData = $post->wasteTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wasteType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('waste_type.show', $wasteType->slug)); ?>" class=" flex flex-row items-center md:hover:underline underline-offset-2 group bg-gray-200 dark:bg-gray-600 rounded-full px-3 py-2 ml-2">
...
<?php /**PATH /Users/kylymbekmazaripov/Sites/ecomoney/resources/views/livewire/post-full.blade.php ENDPATH**/ ?>