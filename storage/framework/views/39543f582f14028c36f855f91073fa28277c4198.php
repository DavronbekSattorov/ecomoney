<div class="md:w-104 block md:mx-1 mt-8 text-base ">
    ...
    <div class=" border bg-white dark:bg-gray-800 dark:text-white rounded-lg shadow-sm sticky top-[4.25rem]  ">
        ...
        <a href="<?php echo e(route('club.edit',$club->slug)); ?>" class="absolute right-2 bottom-2 group md:hover:bg-gray-200/75 md:dark:hover:bg-gray-600 md:active:bg-gray-200 md:dark:active:bg-gray-500 transition ease-out duration-100 rounded-full p-2">
        ...
        <img src="<?php echo e(asset('images/club-card-background.jpg')); ?>" class="w-full rounded-t-lg" />
        <div class="flex justify-center -mt-8">
            <img src="<?php echo e($club->getProfilePhotoUrlAttribute()); ?>" class="w-28 h-28 object-cover rounded-full border-solid border-white border-2 -mt-3 bg-gray-100">
        </div>
        <div class="text-left px-3 pb-4 pt-2">
            <h3 class="flex justify-between items-center text-gray-700 dark:text-white text-lg bold font-sans">
                <span><?php echo e($club->title); ?></span>
...
<?php endif; ?>
            ...
            <div class="text-sm leading-normal mt-0 mb-2 dark:text-gray-300 font-medium lowercase">
                <?php echo e($club->slug); ?>

            </div>
            <p class="mt-2 font-sans font-light dark:text-white tracking-wider">
                <?php echo e($club->about); ?>

            </p>
            <div class="flex justify-start text-base dark:text-gray-300 mt-2">

                <a class="w-1/3 truncate " href="<?php echo e(route('club.show',$club->slug).'?searchType=members'); ?>">
                    <label for="followers" class="cursor-pointer
                                        sm:hover:text-green-500
                    "><?php echo e($actionsCount['membersCount']); ?><span class="text-sm  pl-1 ">Members </span></label>
                </a>
...
<?php /**PATH /var/www/html/resources/views/livewire/club-card.blade.php ENDPATH**/ ?>