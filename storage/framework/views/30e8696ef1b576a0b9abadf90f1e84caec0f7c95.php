        ...
        <div class="w-full md:mx-2">
            <div class="flex items-center justify-between ">
                <div class="flex items-center text-xs  space-x-2 ">
                        <a href="<?php echo e(route('user.show',$comment->user->username)); ?>" class=" flex items-center group" >
                            <img src="<?php echo e($comment->user->getProfilePhotoUrlAttribute()); ?>" alt="avatar" class="w-7 h-7 object-cover rounded-full md:group-hover:ring-2 ring-main-green-light">
                            <div class="ml-2 md:group-hover:underline underline-offset-2" ><?php echo e($comment->user->name); ?></div>
                        </a>
                    ...
                    <?php if($comment->user->id === $postUserId): ?>
                        ...
                        <div>&bull;</div>
                    <?php endif; ?>
                    <div class="truncate"><?php echo e($comment->created_at->diffForHumans(null, false, true)); ?></div>
                </div>
                <?php if(auth()->guard()->check()): ?>
                    <?php if(!$simpleComment): ?>
                        <div
...
<?php /**PATH /Users/kylymbekmazaripov/Sites/ecomoney/resources/views/livewire/post-comment.blade.php ENDPATH**/ ?>