...
<?php endif; ?>
    ...
    <div class="mt-5 md:mt-0 md:col-span-2">
        <div class="px-4 py-5 sm:p-6 bg-white shadow sm:rounded-lg dark:bg-gray-700">
            <?php echo e($content); ?>

        </div>
    </div>
</div>
<?php /**PATH /Users/kylymbekmazaripov/Sites/ecomoney/resources/views/vendor/jetstream/components/action-section.blade.php ENDPATH**/ ?>