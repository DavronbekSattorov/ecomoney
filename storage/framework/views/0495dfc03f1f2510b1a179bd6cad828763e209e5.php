...
<?php $component->withAttributes(['id' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($id),'maxWidth' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($maxWidth),'attributes' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($attributes)]); ?>
    <div class="px-6 py-4 dark:text-gray-200 dark:bg-gray-700">
        <div class="text-lg">
            <?php echo e($title); ?>
    ...
    <div class="flex flex-row justify-end px-6 py-4 bg-gray-100 text-right dark:bg-gray-600">
        <?php echo e($footer); ?>
...
<?php endif; ?>
<?php /**PATH /Users/kylymbekmazaripov/Sites/ecomoney/resources/views/vendor/jetstream/components/dialog-modal.blade.php ENDPATH**/ ?>