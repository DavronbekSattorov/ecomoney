...
} elseif ($_instance->childHasBeenRendered('xDsRVWx')) {
    $componentId = $_instance->getRenderedChildComponentId('xDsRVWx');
    $componentTag = $_instance->getRenderedChildComponentTagName('xDsRVWx');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('xDsRVWx');
} else {
    $response = \Livewire\Livewire::mount('navigation-menu', []);
    $html = $response->html();
    $_instance->logRenderedChild('xDsRVWx', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
