...
<?php endif; ?>
        ...
        <?php $__empty_1 = true; $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('post-index', ['post' => $post,'showMore' => 'true'])->html();
    ...
    $response = \Livewire\Livewire::mount('post-index', ['post' => $post,'showMore' => 'true']);
    $html = $response->html();
...
<?php /**PATH /Users/kylymbekmazaripov/Sites/ecomoney/resources/views/livewire/user-index.blade.php ENDPATH**/ ?>