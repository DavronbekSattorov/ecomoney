...
<?php endif; ?>
            ...
            <div>
                <textarea   id="textarea-post" wire:model.defer="description" data-text="window.livewire.find('<?php echo e($_instance->id); ?>')" cols="30" rows="4" class="hidden w-full bg-gray-100 rounded-xl border-none placeholder-gray-600 text-sm px-4 py-2 ck-content-view" placeholder="Content(optional)" ></textarea>
...
<?php /**PATH /Users/kylymbekmazaripov/Documents/projects/and/resources/views/livewire/create-post.blade.php ENDPATH**/ ?>