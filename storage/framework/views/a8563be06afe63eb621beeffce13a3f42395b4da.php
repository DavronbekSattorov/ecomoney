            ...
            <form wire:submit.prevent="addComment" action="#" class="space-y-4 px-4 py-6" novalidate>
                <div>
                    <textarea x-ref="comment" wire:model="comment"
                              data-text="window.livewire.find('<?php echo e($_instance->id); ?>')" name="post_comment" id="post_comment" cols="30" rows="4" class="hidden " placeholder="Share your thoughts..." ></textarea>
...
<?php /**PATH /var/www/html/resources/views/livewire/add-comment.blade.php ENDPATH**/ ?>