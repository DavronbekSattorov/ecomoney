    ...
    <div class="filters flex flex-col md:flex-row space-y-3 md:space-y-0 md:space-x-6 dark:text-white">
            ...
            <div class="w-full md:w-1/2">
                ...
                <select
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $rec_waste_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wasteType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
    ...
    <?php if(!$searchType  || $searchType ==='posts' ): ?>
        <div class="sm:flex sm:flex-wrap box-border">
            <?php $__empty_1 = true; $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('post-index', ['post' => $post])->html();
    ...
    $response = \Livewire\Livewire::mount('post-index', ['post' => $post]);
    $html = $response->html();
...
<?php /**PATH /Users/kylymbekmazaripov/Sites/ecomoney/resources/views/livewire/posts-index.blade.php ENDPATH**/ ?>