<x-app-layout>
    <form action="/club/{{$club->slug}}" method="post" enctype="multipart/form-data">
        ...
        <x-jet-input  name="title" id="title" value="{{ $club->title}}" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-main-green-light focus:border-main-green-light dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-main-green-light dark:focus:border-main-green-light" type="text" required/>
